...
import net.MaouGaukken.CreateMechanisms.Compiler.ModBlocks;
import net.MaouGaukken.CreateMechanisms.Compiler.ModFluidTypes;
import net.MaouGaukken.CreateMechanisms.Compiler.ModFluids;
import net.MaouGaukken.CreateMechanisms.Compiler.ModItems;
...
public abstract class EnderiamFluid extends BaseFlowingFluid {
    ...
    public static final Properties PROPERTIES = new Properties(() -> ModFluidTypes.ENDERIAM_TYPE.get(),
